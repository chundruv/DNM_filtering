...
class MemoryEfficientPipeline:
    ...
    def _run_warmup_sequential(
        ...
        """Stage 1: Run warmup sequentially to minimize memory."""
        warmup_params = {}
        ...
        for var_type in targets:
            ...
            # Filter to this variant type using boolean mask (creates view, not copy)
    ...
    def _run_full_optimisation_sequential(
        ...
        """Stage 3: Run full optimization sequentially."""
        final_params = {}
        scores = {}
    ...
    def _optimize_with_arrays(
        ...
        # Run optimisation - always single threaded to avoid memory multiplication
        ...
        self._log_best_params(study, arrays, targets)
        
        return study.best_params, study.best_value
    
    def _log_best_params(self, study: optuna.Study, arrays: OptimisationArrays, targets: np.ndarray):
